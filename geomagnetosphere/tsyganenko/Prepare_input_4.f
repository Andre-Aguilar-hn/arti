...
c      DO 777 IYEAR=1995,2008
      DO 777 IYEAR=2023,2023
      ...
      SWNAME='2023_IMF_and_SW_gaps_le_2hrs_filled_SYMH_filled.txt'
      LISTNAME='2023_Interval_list.txt'
      NAMEOUT='2023_OMNI_5m_with_TS05_variables.dat'
      ENDIF
C
c      OPEN (UNIT=1,FILE='Parameters.par')
c      READ (1,200) (A(I),I=1,69)
c200   FORMAT(G15.6)
c      CLOSE(1)
